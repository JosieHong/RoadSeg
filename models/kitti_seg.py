...
LastEditTime: 2021-02-01 01:49:29
'''
...
class Hall_Module(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(2048, 2048, kernel_size=3, padding=(1,1)) # 'same' padding, padding = (kernel-1)/2 = (3-1)/2 = 1
...
class Kitti_Seg(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.relu(output).view(-1, img_size[0], img_size[1]) # torch.Size([batch_size, 256, 256])